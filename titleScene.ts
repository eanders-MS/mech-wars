namespace mech {
    export class TitleScene extends Scene {
        ...
        constructor() {
            ...
            this.mechSprite.xfrm.localPos.y = Fx8(Screen.SCREEN_TOP + (this.mechSprite.img.height >> 1) + 2);
            ...
            this.mechAnimIn.addFrame(new EaseFrame({
                ...
                endValue: new Vec2(Fx8(-18), this.mechSprite.xfrm.localPos.y),
            ...
            this.warsAnimIn.addFrame(new EaseFrame({
                ...
                endValue: new Vec2(Fx8(14), this.warsSprite.xfrm.localPos.y),
                curve: easing.easeIn(easing.curves.sq5)
            }));

            this.mechAnimIn.start();
            setTimeout(() => this.warsAnimIn.start(), 275);
        }
